...
#include "RUAS.h"
void RUAS::preprocess(std::vector<float32_t> &dest_buffer, cv::Mat &img, std::vector<int> dims)
{
    LOGI("RUAS PREPROCESS is called");
...
void RUAS::postprocess(cv::Mat &outputimg){
    LOGI("RUAS Class post-process");
