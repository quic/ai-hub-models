...
void QuickSRNetMedium::preprocess(cv::Mat &img, std::vector<int> dims)
{
    LOGI("QuickSRNetMedium Class Preprocess is called");
...
void QuickSRNetMedium::postprocess(cv::Mat &outputimg) {
...
void QuickSRNetMedium::msg()
{
    LOGI("QuickSRNetMedium Class msg");
}