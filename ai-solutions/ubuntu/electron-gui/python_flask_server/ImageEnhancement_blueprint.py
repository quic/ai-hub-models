...
def buildnetwork_ie(socket, model_name, run_time):
    ...
    dlc_name_decoder={'Enlighten':'enlighten_quantized.dlc', 'RUAS':'ruas_quantized.dlc','SCI':'sci_quantized.dlc','StableLLVE':'StableLLVE_quantized.dlc','Zero-DCE':'zero_dce_quantized.dlc'}
    dlc_path = bytes(pyinstaller_absolute_path(os.path.join("DLC","enhancement", dlc_name_decoder.get(model_name))),'utf-8')
