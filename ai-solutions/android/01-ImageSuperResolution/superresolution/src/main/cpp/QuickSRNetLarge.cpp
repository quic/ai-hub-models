...
void QuickSRNetLarge::preprocess(std::vector<float32_t> &dest_buffer, cv::Mat &img, std::vector<int> dims)
{
...
void QuickSRNetLarge::postprocess(cv::Mat &outputimg) {
