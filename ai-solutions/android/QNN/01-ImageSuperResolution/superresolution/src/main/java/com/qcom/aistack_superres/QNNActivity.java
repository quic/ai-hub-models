...
public class QNNActivity extends AppCompatActivity {
    ...
    String[] modeloptions = { "No Selection", "SESR", "XLSR", "quickSR_large", "quickSR_medium", "quickSR_small"};
//    String[] modeldlcname = { "None", "sesr_quant_128_4.dlc", "esrgan_quant_128_4.dlc", "xlsr_quant_128_4.dlc", "libQuicksrnet_large_quant.serialized.bin", "quicksrnet_medium_quant_128_4.dlc","quicksrnet_small_quant_128_4.dlc"};
    ...
    Map<String, String> runtimeSpecificModels = new HashMap<String, String>() {{
        ...
        put(modeloptions[1] + "|" + backendname[1], "sesr_w8a8.serialized.bin");
        put(modeloptions[2] + "|" + backendname[0], "libxlsr_w8a8.so");
        put(modeloptions[2] + "|" + backendname[1], "xlsr_w8a8.serialized.bin");
