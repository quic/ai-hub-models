...
# [FFNet-54S-Quantized: Semantic segmentation for automotive street scenes](https://aihub.qualcomm.com/models/ffnet_54s_quantized)
...
```bash
pip install "qai_hub_models[ffnet-54s-quantized]"
```
