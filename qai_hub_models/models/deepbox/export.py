...
def export_model(
    ...
    **additional_model_kwargs,
    ...
    if "Yolo" in components:
        components_dict["Yolo"] = model.bbox2D_dectector  # type: ignore[assignment]
    if "VGG" in components:
        components_dict["VGG"] = model.bbox3D_dectector  # type: ignore[assignment]
