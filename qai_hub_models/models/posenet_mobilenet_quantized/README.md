...
This is based on the implementation of Posenet-Mobilenet-Quantized found [here](https://github.com/rwightman/posenet-pytorch). This repository contains scripts for optimized on-device
