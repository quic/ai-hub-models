...
from qai_hub_models.models.face_attrib_net_quantized import Model
...
def export_model(
    ...
    **additional_model_kwargs,
    ...
    """
    model_name = "face_attrib_net_quantized"
    ...
    if precision != Precision.float:
        ...
        calibration_data = quantization_utils.get_calibration_data(
            input_spec, "face_attrib_dataset", num_calibration_samples
        )
