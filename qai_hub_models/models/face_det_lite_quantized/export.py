...
from qai_hub_models.models.face_det_lite_quantized import Model
...
def export_model(
    ...
    **additional_model_kwargs,
    ...
    """
    model_name = "face_det_lite_quantized"
    ...
    if not can_access_qualcomm_ai_hub():
        return export_without_hub_access(
            "face_det_lite_quantized",
            "Lightweight-Face-Detection-Quantized",
