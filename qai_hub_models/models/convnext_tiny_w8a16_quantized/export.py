...
def export_model(
    ...
    **additional_model_kwargs,
    ...
    quantize_job = hub.submit_quantize_job(
        ...
        weights_dtype=Precision.w8a16.weights_type,  # type: ignore[arg-type]
        activations_dtype=Precision.w8a16.activations_type,  # type: ignore[arg-type]
        name=model_name,
        options=model.get_hub_quantize_options(Precision.w8a16),
    )
    if skip_compiling:
