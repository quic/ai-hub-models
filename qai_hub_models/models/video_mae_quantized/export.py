...
def export_model(
    ...
    **additional_model_kwargs,
    ...
    """
    model_name = "video_mae_quantized"
    ...
    if precision != Precision.float:
        ...
        calibration_data = quantization_utils.get_calibration_data(
            input_spec, "kinetics400_224", num_calibration_samples
        )
...
def main():
    ...
    parser = export_parser(model_cls=Model, supports_qnn=False, is_hub_quantized=True)
