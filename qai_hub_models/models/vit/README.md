...
This is based on the implementation of VIT found [here](https://github.com/pytorch/vision/blob/main/torchvision/models/vision_transformer.py). This repository contains scripts for optimized on-device
export suitable to run on Qualcomm® devices. More details on model performance
across various devices, can be found [here](https://aihub.qualcomm.com/models/vit).
...
```bash
python -m qai_hub_models.models.vit.demo { --quantize w8a16, w8a8, w8a8_mixed_int16 }
```
...
```bash
python -m qai_hub_models.models.vit.export { --quantize w8a16, w8a8, w8a8_mixed_int16 }
```
