...
across various devices, can be found [here](https://aihub.qualcomm.com/models/yamnet).
...
```bash
python -m qai_hub_models.models.yamnet.demo { --quantize w8a8 }
```
...
```bash
python -m qai_hub_models.models.yamnet.export { --quantize w8a8 }
```
