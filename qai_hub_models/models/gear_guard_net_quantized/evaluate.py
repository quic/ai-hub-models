...
from qai_hub_models.models.gear_guard_net_quantized import MODEL_ID, Model
from qai_hub_models.models.gear_guard_net_quantized.export import export_model
