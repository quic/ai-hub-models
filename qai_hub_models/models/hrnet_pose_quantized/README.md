...
This is based on the implementation of HRNetPoseQuantized found [here](https://github.com/quic/aimet-model-zoo/tree/develop/aimet_zoo_torch/hrnet_posenet). This repository contains scripts for optimized on-device
...
```bash
pip install "qai_hub_models[hrnet-pose-quantized]"
```
