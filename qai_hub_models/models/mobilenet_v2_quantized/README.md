...
This is based on the implementation of MobileNet-v2-Quantized found [here](https://github.com/tonylins/pytorch-mobilenet-v2/tree/master). This repository contains scripts for optimized on-device
