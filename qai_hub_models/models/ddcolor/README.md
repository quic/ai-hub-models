...
across various devices, can be found [here](https://aihub.qualcomm.com/models/ddcolor).
...
```bash
python -m qai_hub_models.models.ddcolor.demo { --quantize w8a8_mixed_int16, w8a8 }
```
...
```bash
python -m qai_hub_models.models.ddcolor.export { --quantize w8a8_mixed_int16, w8a8 }
```
