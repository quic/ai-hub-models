...
across various devices, can be found [here](https://aihub.qualcomm.com/models/llama_v3_taide_8b_chat).
...
For llama_v3_taide_8b_chat, some additional functionality can be faster or is availiable
...
```bash
# NOTE: 3.10 <= PYTHON_VERSION < 3.14 is supported.
pip install "qai-hub-models[llama-v3-taide-8b-chat]" onnxruntime-gpu==1.22 https://github.com/quic/aimet/releases/download/2.20.0/aimet_onnx-2.20.0+cu121-cp310-cp310-manylinux_2_34_x86_64.whl -f https://download.pytorch.org/whl/torch_stable.html
```
