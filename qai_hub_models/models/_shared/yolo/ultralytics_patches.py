...
def patch_yolo_detection_head(model: DetectionModel):
    """
    ...
    head._inference = functools.partial(patched_ultryaltics_det_head_inference, head)
...
def patched_ultryaltics_det_head_forward(
    ...
    if self.training:  # Training path
        return boxes, scores
    yboxes, yscores = self._inference(boxes, scores)
