...
# [Mobile_Vit: Imagenet classifier and general purpose backbone](https://aihub.qualcomm.com/models/mobile_vit)
...
accross various devices, can be found here:
  ...
  - [float](https://aihub.qualcomm.com/models/mobile_vit)
  - [w8a8](https://aihub.qualcomm.com/models/mobile_vit_w8a8_quantized)
...
```bash
python -m qai_hub_models.models.mobile_vit.demo { --quantize w8a8 }
```
...
```bash
python -m qai_hub_models.models.mobile_vit.export { --quantize w8a8 }
```
