...
from qai_hub_models.models.yolov11_det_quantized import Model
...
def export_model(
    ...
    **additional_model_kwargs,
    ...
    """
    model_name = "yolov11_det_quantized"
    ...
    if precision != Precision.float:
        ...
        calibration_data = quantization_utils.get_calibration_data(
            input_spec, "coco", num_calibration_samples
        )
