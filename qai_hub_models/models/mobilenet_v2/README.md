...
accross various devices, can be found here:
  ...
  - [float](https://aihub.qualcomm.com/models/mobilenet_v2)
  - [w8a8](https://aihub.qualcomm.com/models/mobilenet_v2_quantized)
...
```bash
python -m qai_hub_models.models.mobilenet_v2.demo { --quantize w8a8 }
```
...
```bash
python -m qai_hub_models.models.mobilenet_v2.export { --quantize w8a8 }
```
