...
across various devices, can be found [here](https://aihub.qualcomm.com/models/mobilenet_v2).
...
```bash
python -m qai_hub_models.models.mobilenet_v2.demo { --quantize w8a16, w8a16_mixed_int16, w8a8 }
```
...
```bash
python -m qai_hub_models.models.mobilenet_v2.export { --quantize w8a16, w8a16_mixed_int16, w8a8 }
```
