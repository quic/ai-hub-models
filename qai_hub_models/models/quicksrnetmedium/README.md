...
This is based on the implementation of QuickSRNetMedium found [here](https://github.com/quic/aimet-model-zoo/tree/develop/aimet_zoo_torch/quicksrnet). This repository contains scripts for optimized on-device
export suitable to run on Qualcomm® devices. More details on model performance
accross various devices, can be found here:

  - [float](https://aihub.qualcomm.com/models/quicksrnetmedium)
  - [w8a8](https://aihub.qualcomm.com/models/quicksrnetmedium_quantized)
