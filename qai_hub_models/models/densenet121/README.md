...
across various devices, can be found [here](https://aihub.qualcomm.com/models/densenet121).
...
```bash
python -m qai_hub_models.models.densenet121.demo { --quantize w8a16, w8a8, w8a8_mixed_int16 }
```
...
```bash
python -m qai_hub_models.models.densenet121.export { --quantize w8a16, w8a8, w8a8_mixed_int16 }
```
