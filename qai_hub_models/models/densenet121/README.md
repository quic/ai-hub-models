...
accross various devices, can be found here:
  ...
  - [float](https://aihub.qualcomm.com/models/densenet121)
  - [w8a8](https://aihub.qualcomm.com/models/densenet121_quantized)
...
```bash
python -m qai_hub_models.models.densenet121.demo { --quantize w8a8 }
```
...
```bash
python -m qai_hub_models.models.densenet121.export { --quantize w8a8 }
```
