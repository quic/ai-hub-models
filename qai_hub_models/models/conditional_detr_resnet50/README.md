...
```bash
python -m qai_hub_models.models.conditional_detr_resnet50.demo { --quantize w8a16 }
```
...
```bash
python -m qai_hub_models.models.conditional_detr_resnet50.export { --quantize w8a16 }
```
