...
from qai_hub_models.models.qwen2_5_7b_instruct.export import main as export_main
...
def cli_device_with_skips_unsupported_device(
...
def cli_default_device_select_component(
    export_main: Callable,
    model_cls: type[Model],
    tmp_path: Path,
    base_name: str,
...
def test_cli_device_with_skips_unsupported_device(
    ...
    cli_device_with_skips_unsupported_device(export_main, Model, tmp_path, MODEL_ID)
...
def test_cli_default_device_select_component(
    ...
    cli_default_device_select_component(
        export_main,
        Model,
        tmp_path,
        MODEL_ID,
