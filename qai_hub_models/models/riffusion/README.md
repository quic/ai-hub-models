...
# [Riffusion: State-of-the-art generative AI model used to generate spectrogram images given any text input. These spectrograms can be converted into audio clips](https://aihub.qualcomm.com/models/riffusion)
