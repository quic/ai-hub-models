...
across various devices, can be found [here](https://aihub.qualcomm.com/models/yolov11_det).
...
```bash
python -m qai_hub_models.models.yolov11_det.demo { --quantize w8a8, w8a8_mixed_int16, w8a16 }
```
...
```bash
python -m qai_hub_models.models.yolov11_det.export { --quantize w8a8, w8a8_mixed_int16, w8a16 }
```
