...
DEFAULT_ENCODINGS = "foot_track_net_quantized_encodings_RGB255_cocoVal12_12.json"


class FootTrackNetQuantizable(AIMETQuantizableMixin, FootTrackNet):
    """FootTrackNet_model with post train quantization support.
    ...
    def __init__(
        ...
        FootTrackNet.__init__(self, model.model)
