...
This is based on the implementation of Whisper-Small-En found [here](https://github.com/openai/whisper/tree/main). This repository contains scripts for optimized on-device
...
```bash
pip install "qai_hub_models[whisper-small-en]"
```
