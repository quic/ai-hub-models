...
This is based on the implementation of HRNetFace found [here](https://github.com/HRNet/HRNet-Facial-Landmark-Detection). This repository contains scripts for optimized on-device
export suitable to run on Qualcomm® devices. More details on model performance
accross various devices, can be found [here](https://aihub.qualcomm.com/models/hrnet_face).
