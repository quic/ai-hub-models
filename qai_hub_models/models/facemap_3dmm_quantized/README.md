...
# [Facial-Landmark-Detection-Quantized: Facial landmark predictor with 3DMM](https://aihub.qualcomm.com/models/facemap_3dmm_quantized)
...
```bash
pip install "qai_hub_models[facemap_3dmm_quantized]"
```
