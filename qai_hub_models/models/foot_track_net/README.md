...
accross various devices, can be found here:
  ...
  - [float](https://aihub.qualcomm.com/models/foot_track_net)
  - [w8a8](https://aihub.qualcomm.com/models/foot_track_net_quantized)
...
```bash
python -m qai_hub_models.models.foot_track_net.demo { --quantize w8a8 }
```
...
```bash
python -m qai_hub_models.models.foot_track_net.export { --quantize w8a8 }
```
