...
def export_model(
    ...
    **additional_model_kwargs,
    ...
    if "MediaPipePoseDetector" in components:
        components_dict["MediaPipePoseDetector"] = model.pose_detector  # type: ignore[assignment]
    if "MediaPipePoseLandmarkDetector" in components:
        components_dict["MediaPipePoseLandmarkDetector"] = model.pose_landmark_detector  # type: ignore[assignment]
