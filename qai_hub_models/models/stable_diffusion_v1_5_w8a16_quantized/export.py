...
from qai_hub_models.models.stable_diffusion_v1_5_w8a16_quantized import Model
...
ALL_COMPONENTS = ["TextEncoder", "Unet", "VaeDecoder"]
...
def export_model(
    ...
    **additional_model_kwargs,
    ...
    """
    model_name = "stable_diffusion_v1_5_w8a16_quantized"
    ...
    if "TextEncoder" in components:
        components_dict["TextEncoder"] = model.text_encoder  # type: ignore[assignment]
    if "Unet" in components:
        components_dict["Unet"] = model.unet  # type: ignore[assignment]
    if "VaeDecoder" in components:
        components_dict["VaeDecoder"] = model.vae_decoder  # type: ignore[assignment]
    ...
    for component_name, component in components_dict.items():
        ...
        submitted_compile_job = hub.submit_compile_job(
            ...
            calibration_data=component.get_calibration_data(
                target_runtime, num_samples=5
            ),
