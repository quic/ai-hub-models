...
This is based on the implementation of Midas-V2-Quantized found [here](https://github.com/isl-org/MiDaS). This repository contains scripts for optimized on-device
...
```bash
pip install "qai_hub_models[midas-quantized]"
```
