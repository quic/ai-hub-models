...
This is based on the implementation of Bert-Base-Uncased-Hf found [here](https://github.com/google-research/bert). This repository contains scripts for optimized on-device
export suitable to run on Qualcomm® devices. More details on model performance
across various devices, can be found [here](https://aihub.qualcomm.com/models/bert_base_uncased_hf).
