...
from qai_hub_models.models.mediapipe_face_quantized import MODEL_ID, Model
from qai_hub_models.models.mediapipe_face_quantized.export import export_model
