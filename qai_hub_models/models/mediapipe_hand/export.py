...
def export_model(
    ...
    **additional_model_kwargs,
    ...
    if "MediaPipeHandDetector" in components:
        components_dict["MediaPipeHandDetector"] = model.hand_detector  # type: ignore[assignment]
    if "MediaPipeHandLandmarkDetector" in components:
        components_dict["MediaPipeHandLandmarkDetector"] = model.hand_landmark_detector  # type: ignore[assignment]
