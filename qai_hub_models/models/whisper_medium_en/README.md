# [Whisper-Medium-En: Automatic speech recognition (ASR) model for English transcription as well as translation](https://aihub.qualcomm.com/models/whisper_medium_en)
...
This is based on the implementation of Whisper-Medium-En found [here](https://github.com/openai/whisper/tree/main). This repository contains scripts for optimized on-device
export suitable to run on Qualcomm® devices. More details on model performance
accross various devices, can be found [here](https://aihub.qualcomm.com/models/whisper_medium_en).
...
## License
* The license for the original implementation of Whisper-Medium-En can be found
