...
class SAM2Decoder(BaseModel):
    ...
    def forward(
        ...
        image_embeddings
            ...
            Shape: [1, emb_dim, emb_size, emb_size]
        high_res_features1
            First set of high-resolution features.
            Shape: [1, high_res_1_dim, high_res_1_size, high_res_1_size]
        high_res_features2
            Second set of high-resolution features.
            Shape: [1, high_res_2_dim, high_res_2_size, high_res_2_size]
        sparse_embedding
            The sparse embeddings from the prompt encoder.
            Shape: [1, N+1, 256]
