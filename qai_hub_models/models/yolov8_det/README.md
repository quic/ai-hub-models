...
accross various devices, can be found here:
  ...
  - [float](https://aihub.qualcomm.com/models/yolov8_det)
  - [w8a8](https://aihub.qualcomm.com/models/yolov8_det_quantized)
...
```bash
python -m qai_hub_models.models.yolov8_det.demo { --quantize w8a8 }
```
...
```bash
python -m qai_hub_models.models.yolov8_det.export { --quantize w8a8 }
```
