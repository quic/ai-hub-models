...
ALL_COMPONENTS = ["EasyOCRDetector", "EasyOCRRecognizer"]
...
def export_model(
    ...
    **additional_model_kwargs,
    ...
    if "EasyOCRDetector" in components:
        components_dict["EasyOCRDetector"] = model.detector  # type: ignore[assignment]
    if "EasyOCRRecognizer" in components:
        components_dict["EasyOCRRecognizer"] = model.recognizer  # type: ignore[assignment]
